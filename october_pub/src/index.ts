...
import { createRedisClient, setHashField } from './utilities/redis-connection';
import { gameDetails } from './utilities/common';
import { cleanupGameStates } from './utilities/helper';
...
async function startServer(): Promise<void> {
  try {
    ...
    await cleanupGameStates();
    gameSocket(io);
    app.get('/', (req, res) => {
      res.send("october pub is Up and working")
      console.log("october pub is Up and working")
    })
